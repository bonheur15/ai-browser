  ...
  return (
    <main className="app-shell" onClick={() => spaceMenuId && setSpaceMenuId(null)}>
      <div className="canvas">
        ...
        <div ref={viewportRef} className={`browser-viewport${drawer ? " has-drawer" : ""}`} aria-label="Browser surface">
          {!activeTab && <div className="viewport-fallback"><span className="fallback-orb">✦</span><strong>Choose a surface</strong><small>Open a tab or select a Space to begin.</small></div>}
        </div>
